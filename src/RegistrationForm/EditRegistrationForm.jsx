...
const EditRegistrationForm = () => {
  ...
  if (isLoading) {
    return <div className="form-builder-container">Loading form data...</div>;
  }
    ...
    return (
      <div className="form-builder-container">
        <div className="success-message">
          <h2>Form Successfully Updated!</h2>
          <p>{submissionStatus.message}</p>
          <div className="form-details">
            <h3>Updated Form Details:</h3>
            ...
            <p><strong>Number of Questions:</strong> {submissionStatus.formData.questions?.length || 0}</p>
          </div>
